    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
      {repos.map((repo, index) => (
        ...
        >
          ...
          <h3 className="font-semibold text-lg mb-1 truncate text-white" title={repo.full_name}>
            {repo.name}
          </h3>
          ...
          <button className="w-full py-2 bg-white/5 rounded-lg text-sm font-medium group-hover:bg-primary group-hover:text-white transition-colors flex items-center justify-center gap-2 cursor-pointer text-white">
